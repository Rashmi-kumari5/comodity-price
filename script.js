...
//     const apiUrl = 'https://newsapi.org/v2/everything?q=commodity+price+predictions&apiKey=' + apiKey;
...
//                 output += `<div class="news-item"><a href="${article.url}" target="_blank">${article.title}</a></div>`;
//             });
